...
PS1='$([ -n "$TMUX" ] && tmux setenv TMUXPWD_$(tmux display -p "#I") "$PWD")\e[0;36m\u\e[m@\e[0;34m\h\e[m:\W/\e[0;35m$(__git_ps1 "⭠%s")\e[m\$ ' # The best prompt ever, with colors and wd's git branch
# tmux on start
